...
class DialogComponentWidget extends StatefulWidget {
  ...
  const DialogComponentWidget({
    super.key,
    required this.firstBtnAction,
    required this.secBtnAction,
    required this.text,
    required this.firstBtnText,
    required this.secBtoText,
  });

  final Future Function()? firstBtnAction;
  final Future Function()? secBtnAction;
  final String? text;
  final String? firstBtnText;
  final String? secBtoText;

  @override
  State<DialogComponentWidget> createState() => _DialogComponentWidgetState();
}
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Align(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await widget.firstBtnAction?.call();
                                      },
                                      text: widget.firstBtnText!,
                                ...
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.secBtnAction?.call();
                                    },
                                    text: widget.secBtoText!,
                                    options: FFButtonOptions(
                                      width: 250.0,
                                      height: 40.0,
                                      padding: const EdgeInsetsDirectional.fromSTEB(
