                            ...
                            queryParameters: {
                              'transactionData': serializeParam(
                                TransactionDataStruct(
                                  ...
                                  transactionPostDate:
                                      listTransactionsItem.transactionPostDate,
                                  transactionStatus:
                                      listTransactionsItem.transactionStatus,
                                  merchantCode:
                                      listTransactionsItem.merchantCode,
                                  transactionReference:
                                      listTransactionsItem.transactionReference,
                                  transactionAmount:
                                      listTransactionsItem.transactionAmount,
                                  creditDebit: listTransactionsItem.creditDebit,
                                  transactionCurrencyCode: listTransactionsItem
                                      .transactionCurrencyCode,
                                  billingAmount:
                                      listTransactionsItem.billingAmount,
                                  billingCurrencyCode:
                                      listTransactionsItem.billingCurrencyCode,
                                ),
                                ...
                                child: Padding(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          listTransactionsItem.hasMerchantName()
