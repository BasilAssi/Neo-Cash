...
import 'filter_transactions_component1_model.dart';
...
class FilterTransactionsComponent1Widget extends StatefulWidget {
  ...
  State<FilterTransactionsComponent1Widget> createState() =>
      _FilterTransactionsComponent1WidgetState();
}

class _FilterTransactionsComponent1WidgetState
    extends State<FilterTransactionsComponent1Widget> {
  late FilterTransactionsComponent1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterTransactionsComponent1Model());
  }
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      FFAppState().updateFilterTransactionsStruct(
                        (e) => e
                          ..dateFrom =
                              functions.dateFromCalculate(DateTypes.LAST_MONTH)
                          ..dateTo =
                              functions.dateFromCalculate(DateTypes.TODAY),
                      );
                      setState(() {});
                        ...
                        children: [
                          Padding(
                            ...
                            child: Icon(
                              ...
                              color:
                                  FlutterFlowTheme.of(context).textAppbarColor,
                              size: 28.0,
                            ),
                          ),
                          Expanded(
