  ...
  void initState() {
    ...
    _model.addresslTextFieldTextController ??= TextEditingController(
        text: FFAppState().registerationFormData.hasAddressText()
            ? FFAppState().registerationFormData.addressText
            : '');
    _model.addresslTextFieldFocusNode ??= FocusNode();
  }
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller: _model.cityDropDownValueController ??=
                            ...
                            _model.cityDropDownValue ??=
                                FFAppState().registerationFormData.hasCity()
                                    ? FFAppState().registerationFormData.city
                                    : '',
                          ),
                        ...
                        child: FlutterFlowDropDown<String>(
                          controller:
                            ...
                            _model.populationDropDownValue ??= FFAppState()
                                    ...
                                    .hasPopulation()
                                ? FFAppState().registerationFormData.population
                                : '',
                          ),
                          options: List<String>.from(
                              ['04', '1', '2', '3', 'FEMALE']),
