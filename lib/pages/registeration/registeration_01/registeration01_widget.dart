...
class _Registeration01WidgetState extends State<Registeration01Widget> {
  ...
  void initState() {
    ...
    _model.firstNameTextFieldTextController3 ??= TextEditingController();
    _model.firstNameTextFieldFocusNode3 ??= FocusNode();
  }
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        '838enfc1' /* بمجرد إنشاء حسابك سنرسل لك راب... */,
                      ),
                      style: FlutterFlowTheme.of(context).titleMedium.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).titleMediumFamily,
                  ...
                  Padding(
                    padding: const EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 0.0, 0.0),
                    child: TextFormField(
                      controller: _model.firstNameTextFieldTextController3,
                      focusNode: _model.firstNameTextFieldFocusNode3,
                      autofocus: true,
                      textCapitalization: TextCapitalization.sentences,
                      obscureText: !_model.firstNameTextFieldVisibility2,
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          'gvdhmjks' /* تأكيد كلمة السر */,
                        ),
                        labelStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: FlutterFlowTheme.of(context)
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'gsqk8kbn' /* لازم تكون كلمة السر مكونة من 8... */,
                      ),
                      style: FlutterFlowTheme.of(context).titleMedium.override(
                            fontFamily:
                                FlutterFlowTheme.of(context).titleMediumFamily,
