                        ...
                        child: ListView(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.oldPassTextFieldTextController,
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (FFAppState().AuthenticatedUser.password ==
                              _model.oldPassTextFieldTextController.text) {
                            if (_model.newPassTextFieldTextController.text ==
                              ...
                              if (_model.isNetworkAvailableOutput == true) {
                                _model.apiResultChangePassword =
                                    await CardGroup.changePasswordCall.call(
                                  oldPassword: _model
                                      .oldPassTextFieldTextController.text,
                                  newPassword: _model
                                      .newPassTextFieldTextController.text,
