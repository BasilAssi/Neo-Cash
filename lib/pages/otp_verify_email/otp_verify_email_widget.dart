...
import 'otp_verify_email_model.dart';
export 'otp_verify_email_model.dart';

class OtpVerifyEmailWidget extends StatefulWidget {
  const OtpVerifyEmailWidget({super.key});

  @override
  State<OtpVerifyEmailWidget> createState() => _OtpVerifyEmailWidgetState();
}

class _OtpVerifyEmailWidgetState extends State<OtpVerifyEmailWidget> {
  late OtpVerifyEmailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OtpVerifyEmailModel());
                                ...
                                children: [
                                  TextSpan(
                                    text: FFLocalizations.of(context).getText(
                                      'f562xrix' /*  أرسلنالك رمز تحقق على إيميلك ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                        ...
                        onCompleted: (_) async {
                          ...
                          if (_model.isNetworkAvailableOutput!) {
                            _model.verifyOTPOutputEmail =
                              ...
                              setConfirmed: 'false',
                              idType: FFAppState().AuthenticatedUser.idType,
                            ...
                            if ((_model.verifyOTPOutputEmail?.succeeded ??
                                true)) {
                              if (ResponseModelStruct.maybeFromMap((_model
                                              .verifyOTPOutputEmail?.jsonBody ??
                                          ''))
                                      ?.code ==
                                  '00') {
                            ...
                            children: [
                              if (_model.isTimerEnded == true)
                                InkWell(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'k5owyn2e' /* إعادة إرسال رمز التحقق */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
