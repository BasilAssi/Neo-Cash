...
class TransactionDetailsPageWidget extends StatefulWidget {
  const TransactionDetailsPageWidget({
    super.key,
    required this.transactionData,
  });

  final TransactionDataStruct? transactionData;

  @override
  State<TransactionDetailsPageWidget> createState() =>
      _TransactionDetailsPageWidgetState();
}

class _TransactionDetailsPageWidgetState
    extends State<TransactionDetailsPageWidget> with TickerProviderStateMixin {
  late TransactionDetailsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransactionDetailsPageModel());
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Screenshot(
                  controller: _model.screenshotController,
                  child: Container(
                    decoration: BoxDecoration(
                      color: FlutterFlowTheme.of(context).secondaryBackground,
                    ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ClipRRect(
                                ...
                                child: Image.asset(
                                  'assets/images/152pt__152pt_(@2x)-01.jpg',
                                  width: 40.0,
                                  height: 40.0,
                                  fit: BoxFit.cover,
                                ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'ot0eesux' /* قيمة الحركة بعملة البطاقة */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                        .override(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${widget.transactionData!.hasTransactionAmount() ? widget.transactionData?.transactionAmount : ''} ${widget.transactionData!.hasTransactionCurrencyCode() ? widget.transactionData?.transactionCurrencyCode : ''}',
                                  style: FlutterFlowTheme.of(context)
                                      .titleMedium
                                      .override(
                                        fontFamily: FlutterFlowTheme.of(context)
                      ...
                      Align(
                        ...
                        child: Builder(
                          builder: (context) => FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              final image = await _model.saveImageToDevice();
                              await _model.saveToGallery(
                                image,
                              );
